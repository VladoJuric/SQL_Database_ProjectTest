...
CREATE VIEW [dbo].[vStudentiStudijSmjer]
AS
...
WHERE        (dbo.OsobaOpis.StatusOsobe = 'Student') AND (dbo.AppDataOsoba.StatusAktivnosti = 'DA')
      ...
      Begin Tables = 
         ...
         Begin Table = "Semestar"
            Begin Extent = 
               ...
               Right = 1246
            End
            Disp', 'SCHEMA', N'dbo', 'VIEW', N'vStudentiStudijSmjer', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N'layFlags = 280
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vStudentiStudijSmjer', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vStudentiStudijSmjer', NULL, NULL
GO
