...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[pregled_svih_podataka]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'pregled_svih_podataka', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'pregled_svih_podataka', NULL, NULL
GO
